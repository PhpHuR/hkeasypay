...
<link rel="stylesheet" href="/bank/Public/css/item/show.css?1.1d.1thddde" />
...
<div class="doc-body row">
  <!-- 左侧栏菜单 -->
    <div class="doc-left span3 bs-docs-sidebar pull-left">
      ...
      <input type="hidden" id="base_url" value="/bank/index.php?s=">
...
<script src="/bank/Public/js/jquery.bootstrap-growl.min.js"></script>
<script src="/bank/Public/js/jquery.goup.min.js"></script>
<script src="/bank/Public/js/jquery.hotkeys.js"></script>

<script src="/bank/Public/js/item/show.js?v=1.2121"></script>