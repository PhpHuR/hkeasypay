...
<div class="main-container" id="main-container">
    ...
    <div class="page-content">
        ...
        <div style="margin-top:20px;">
            <form name="admin_list_sea" class="form-search form-horizontal" method="post" action="<?php echo U('turnFoAuditOrderPage');?>">
                <div class="row maintop">
                    ...
                    <div class="col-xs-4 hidden-xs btn-sespan" style="width: 18%;">
                        <div class="input-group" style="width: 90%;">
                            <input type="text" name="mid" id="mid" class="back_wh1" value="<?php echo ($keyy); ?>" style="width: 100%;color:#fff" placeholder="输入需查询的关键字" />
                    ...
                    <div style="display: inline-block;margin-left: 10px">
                        <a href="<?php echo U('turnFoAuditOrderPage');?>">
                            <button type="submit" class="select_search white" style="font-size: 15px">
                                显示全部
                            </button>
                        </a>
        ...
        <div class="row">
            <div class="col-xs-12">
                <div>
                    <form class="ajaxForm" name="audit" method="post" action="<?php echo U('turnFoAuditOrderPage');?>" >
                        ...
                        <table class="white" id="dynamic-table">
                            ...
                            <?php if(is_array($audit_list)): foreach($audit_list as $key=>$v): ?><tr>
                                    <td class="hidden-xs hidden-sm" align="center">
                                        <div class="border_margin">
                                            <label class="pos-rel">
                                                <input name='n_id[]' id="navid" class="ace"  type='checkbox' value='<?php echo ($v["payout_id"]); ?>'>
                                                <span class="lbl"></span>
                                            </label>
                                        </div>

                                    </td>
                                    <td class="hidden-xs hidden-sm" height="28" ><div class="border_margin"><?php echo ($v["payout_id"]); ?></div></td>
                                    ...
                                    <td class="hidden-sm">
                                        <div class="border_margin">
                                            <div class="hidden-sm hidden-xs action-buttons">
                                                <a class="green payoutAudit"  href="<?php echo U('turnFoAuditOrderPage');?>" data-id="<?php echo ($v["payout_id"]); ?>" title="审核">
                                            ...
                                            <div class="hidden-md hidden-lg">
                                                <div class="inline position-relative">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
                                                        <li>
                                                            <a href="<?php echo U('turnFoAuditOrderPage');?>" data-id="<?php echo ($v["payout_id"]); ?>" class="tooltip-success payoutAudit" data-rel="tooltip" title="" data-original-title="审核">
																	<span class="green">
                            ...
                            <tr>
                                ...
                                <td height="50" colspan="18" align="left">
                                    <a class="btn btn-sm btn-warning"  href="<?php echo U('turnFoAuditOrderPage',array('action'=>'export','reservation'=>$sldate,'status'=>$status));?>"  title="导出报表">
    ...
    <div class="modal fade in" id="myModaledit" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        ...
        <form class="form-horizontal ajaxForm2" name="runAuditOrder" method="post" action="<?php echo U('runAuditOrder');?>">
