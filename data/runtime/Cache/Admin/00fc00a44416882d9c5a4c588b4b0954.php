...
<div class="main-container" id="main-container">
    ...
    <div class="page-content">
        ...
        <form name="admin_list_sea" class="form-search form-horizontal" method="post" action="<?php echo U('select');?>">
            <div class="row maintop">
                <div class="fl_right">
                        <div class="white" style="position:relative;z-index: 1050;top: -51px">
                            <input type="text" name="val" id="val" class="admin_search bgtouming" value="<?php echo ($keyy); ?>" placeholder="输入需查询的关键字" />
                ...
                <div>
                    <table class="urllist white" id="dynamic-table">
                        ...
                        <?php if(is_array($select_list)): foreach($select_list as $key=>$v): ?><tr>
                                ...
                                <td class="hidden-sm hidden-xs">
                                    <div class="border_margin">
                                        <?php switch($v["status"]): case "1": ?><span
                                                    style="color:#64c505;margin-top: 6px;display: block">成功</span><?php break;?>
                                            <?php case "-1": ?><span style="color:#e55546;margin-top: 6px;display: block">支付失败</span><?php break;?>
                                            <?php case "2": ?><span
                                                    style="color:#5490e1;margin-top: 6px;display: block">退款中</span><?php break;?>
                                            <?php case "3": ?><span style="color:#e55546;margin-top: 6px;display: block">退款失败</span><?php break;?>
                                            <?php case "4": ?><span style="color:#64c505;margin-top: 6px;display: block">退款成功</span><?php break;?>
                                            <?php default: ?>
                                            <span style="color:#5490e1;margin-top: 6px;display: block;">待支付</span><?php endswitch;?>
                                    </div>
                                </td>
                                <td class="hidden-sm">
                                ...
                                <td class="hidden-sm hidden-xs"><p><?php echo (getBankName($v["paybank"])); ?></p></td>
                                <td class="hidden-sm hidden-xs"><p><?php echo ($v["remark"]); ?></p></td>
                                <td class="hidden-sm hidden-xs"><p><?php echo ($v["payin_method"]); ?></p></td>
                                <td class="hidden-sm hidden-xs">
                                    <?php if($v['agsettle_status'] == 1 ): ?><div class="border_margin">
                                            <span class="">已结算</span>
                                        </div>
                                        <?php else: ?>
                                        <div class="border_margin">
                                ...
                                <td class="hidden-sm hidden-xs">
                                    <div class="border_margin hidden-xs action-buttons">
                                        <a class="payin-btn" style="color:#d0b990" href="<?php echo U('select');?>" data-id="<?php echo ($v["payin_id"]); ?>"
                                           title="詳情">
