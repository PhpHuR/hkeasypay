...
//            			foreach ( $res as $k => $v ){
//				if ($k != 1){
//					$data ['order_log_id'] = $v[0];
//					$data ['uid'] = $v[1];
//					$data ['orderid'] = $v[2];
//					$data ['currency_id'] = $v[3];
//					$data ['t_type'] = $v[4];
//					$data ['income'] = $v[5];
//					$data ['outlay'] = $v[6];
//					$data ['balance'] = $v[7];
...
//                    $data ['payout_id'] = $v[0];
//                    $data ['uid'] = $v[1];
//                    $data ['member_name'] = $v[2];
//                    $data ['payout_mid'] = $v[3];
//                    $data ['attribute'] = $v[4];
//                    $data ['payout_orderid'] = $v[5];
//                    $data ['batchnum'] = $v[6];
//                    $data ['currency_id'] = $v[7];
//                    $data ['type'] = $v[8];
//                    $data ['reaccname'] = $v[9];
//                    $data ['reaccno'] = $v[10];
//                    $data ['bankname'] = $v[11];
...
//                    $data ['operato'] = $v[16];
//                    $data ['filename'] = $v[17];
//                    $data ['transfermoney'] = $v[18];
//                    $data ['settlementmoney'] = $v[19];
//                    $data ['free'] = $v[20];
//                    $data ['payout_commission_c'] = $v[21];
//                    $data ['payout_commission_ag'] = $v[22];
//                    $data ['status'] = $v[23];
//                    $data ['begin_time'] = $v[24];
//                    $data ['audit_time'] = $v[25];
//                    $data ['result_time'] = $v[26];
//                    $data ['remark'] = $v[27];
//                    $data ['result_remark'] = $v[28];
//
...
//                    $data ['payin_id'] = $v[0];
//                    $data ['uid'] = $v[1];
//                    $data ['payment_mid'] = $v[2];
//                    $data ['orderid'] = $v[3];
//                    $data ['pay_orderid'] = $v[4];
//                    $data ['transid'] = $v[5];
//                    $data ['currency_id'] = $v[6];
//                    $data ['product_id'] = $v[7];
//                    $data ['remark'] = $v[8];
//                    $data ['paybank'] = $v[9];
//                    $data ['payment_id'] = $v[10];
//                    $data ['ordermoney'] = $v[11];
//                    $data ['begin_time'] = $v[12];
//                    $data ['end_time'] = $v[13];
//                    $data ['factmoney'] = $v[14];
//                    $data ['free'] = $v[15];
//                    $data ['settlement'] = $v[16];
//                    $data ['payin_commission_c'] = $v[17];
//                    $data ['payin_commission_ag'] = $v[18];
//                    $data ['status'] = $v[19];
//                    $data ['m_status'] = $v[20];
//                    $data ['notice_status'] = $v[21];
//                    $data ['payin_method'] = $v[22];
//                    $data ['returnurl'] = $v[23];
//                    $data ['notifyurl'] = $v[24];
//                    $data ['source'] = $v[25];
//                    $data ['settlements_status'] = $v[26];
//
//                    $result = M ('payin')->add ($data);
//                    if (!$result){
//                        $this->error ('导入数据库失败',U('excel_import'),0);
//                    }
//                }
...
//            foreach ( $res as $k => $v ){
//                if ($k != 1){
//                    $data ['payininfo_id'] = $v[0];
//                    $data ['payin_id'] = $v[1];
//                    $data ['uid'] = $v[2];
//                    $data ['customer_name'] = $v[3];
//                    $data ['customer_id'] = $v[4];
//                    $data ['cert_type'] = $v[5];
//                    $data ['cert_number'] = $v[6];
//                    $data ['email'] = $v[7];
//                    $data ['tel'] = $v[8];
//                    $data ['bank_number'] = $v[9];
//                    $data ['update_time'] = $v[10];
//
//                    $result = M ('payininfo')->add ($data);
//                    if (!$result){
//                        $this->error ('导入数据库失败',U('excel_import'),0);
//                    }
//                }
...
//            foreach ( $res as $k => $v ){
//                if ($k != 1){
//                    $data ['agentpayin_id'] = $v[0];
//                    $data ['user_id'] = $v[1];
//                    $data ['agent_id'] = $v[2];
//                    $data ['agent_pid'] = $v[3];
//                    $data ['agentpayin_order_id'] = $v[4];
//                    $data ['payin_order_id'] = $v[5];
//                    $data ['order_money'] = $v[6];
//                    $data ['agentfree'] = $v[7];
//                    $data ['agent_rate'] = $v[8];
//                    $data ['paybank'] = $v[9];
//                    $data ['attribute'] = $v[10];
//                    $data ['update_time'] = $v[11];
//                    $result = M ('agentpayin')->add ($data);
//                    if (!$result){
//                        $this->error ('导入数据库失败',U('excel_import'),0);
//                    }
//                }
