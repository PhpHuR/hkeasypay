...
function order(){
	...
	$customs=encode_json($_POST["customsInfos"]);

    //加入请求参数
	$jsonRequest="{\"serialNumber\":\"".$_POST["paySerialNumber"]."\",
	...
	\"customsInfos\": ". trim($customs,'"');
	$jsonRequest=$jsonRequest."}";
$request->setJsonParam($jsonRequest);
    //提交Post请求
    $response = YopClient3::post("/rest/v1.0/kj/customs/order", $request);
